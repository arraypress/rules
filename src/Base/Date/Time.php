...
/**
 * Base class for time fields.
 */
abstract class Time extends Rule {
	...
	public function get_tooltip(): string {
		return sprintf(
			esc_html__( 'Enter the %s time you want to check', 'arraypress' ),
			$this->get_field_name()
		);
	}
	 ...
	 */
	abstract protected function get_compare_value( array $args ): string;
