...
class Created extends Date {
	...
	public function get_label(): string {
		return esc_html__( 'Commission Date Created', 'arraypress' );
	}
	...
	protected function get_field_name(): string {
		return esc_html__( 'paid date', 'arraypress' );
	}
	...
	protected function get_compare_value( array $args ): string {
		...
		return $commission ? date( 'Y-m-d', strtotime( $commission->date_created ) ) : '';
	}
