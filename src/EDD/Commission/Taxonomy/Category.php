...
class Category extends BaseCategory {
	...
	public function get_label(): string {
		return esc_html__( 'Commission Product Category', 'arraypress' );
	}
	...
	public function get_placeholder(): string {
		return esc_html__( 'Search product categories...', 'arraypress' );
	}
	...
	public function get_tooltip(): string {
		return esc_html__( 'Select categories to check against the commission product.', 'arraypress' );
	}
