...
/**
 * Base class for unit-based fields (time, distance, etc.).
 */
abstract class Unit extends Rule {
	...
	public function get_field_args( array $args ): array {
		...
		$args['units']            = $this->get_available_units();
	...
	public function get_tooltip(): string {
		return sprintf(
			esc_html__( 'Enter the %s to check', 'arraypress' ),
			$this->get_field_name()
		);
	}
	 ...
	 *
	 * @return array Array of valid units
	 */
	abstract protected function get_available_units(): array;
