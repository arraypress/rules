...
class AllAccess extends Number {
	...
	public function get_label(): string {
		return esc_html__( 'Customer All Access Count', 'arraypress' );
	}
	...
	protected function get_field_name(): string {
		return esc_html__( 'number of all access', 'arraypress' );
	}
	...
	protected function get_compare_value( array $args ): int {
		return Customer::get_all_access_count( $args['customer_id'] );
	}
