<?php
/**
 * License products count rule class.
 *
 * This class handles validation and comparison of license product counts in the EDD cart.
 *
...
class License extends Integer {
	...
	public function get_label(): string {
		return esc_html__( 'License Products Count', 'arraypress' );
	}
	...
	protected function get_field_name(): string {
		return esc_html__( 'license count', 'arraypress' );
	}
	...
	protected function get_compare_value( array $args ): int {
		return Cart::get_licensing_count();
	}
