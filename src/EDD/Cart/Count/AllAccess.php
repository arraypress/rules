<?php
/**
 * All Access products count rule class.
 *
 * This class handles validation and comparison of all access product counts in the EDD cart.
 *
...
class AllAccess extends Integer {
	...
	public function get_label(): string {
		return esc_html__( 'All Access Products Count', 'arraypress' );
	}
	...
	protected function get_field_name(): string {
		return esc_html__( 'all access count', 'arraypress' );
	}
	...
	protected function get_compare_value( array $args ): int {
		return Cart::get_all_access_count();
	}
