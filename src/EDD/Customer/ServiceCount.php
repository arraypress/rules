 ...
 */
class ServiceCount extends Number {
	...
	public function get_label(): string {
		return esc_html__( 'Customer Service Count', 'arraypress' );
	}
	...
	protected function get_field_name(): string {
		return esc_html__( 'number of service purchases', 'arraypress' );
	}
	...
	protected function get_compare_value( array $args ): int {
		return Customer::get_service_count( $args['customer_id'] );
	}
